...
config :family_dashboard, FamilyDashboardWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: FamilyDashboardWeb.ErrorHTML, json: FamilyDashboardWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: FamilyDashboard.PubSub,
  live_view: [signing_salt: "lFSk8wOp"]
...
config :family_dashboard, FamilyDashboard.Mailer, adapter: Swoosh.Adapters.Local
